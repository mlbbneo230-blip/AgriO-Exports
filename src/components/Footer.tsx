                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="pt-4 flex items-center space-x-4">
                            ...
                            <a href="https://www.instagram.com/agrio_exports?igsh=MTMzNXJvY3U0dWlmbQ==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary-light flex items-center justify-center text-secondary hover:bg-secondary hover:text-primary transition-colors">
